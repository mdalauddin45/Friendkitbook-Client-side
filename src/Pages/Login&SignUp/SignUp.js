  ...
  return (
    <div className="card   lg:card-side md:card-side lg:pl-20 py-20">
      <figure className="">
        <img
          src={signupImg1}
          className="hidden md:block lg:block rounded-xl h-[540px] w-[490px] "
          alt="Album"
        />
        <img
          src={signupImg2}
          className="hidden absolute md:block lg:block rounded-xl h-[540px] w-[490px] "
          alt="Album"
        />
      </figure>
            ...
            <div className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full px-4 py-5 border rounded-lg border-gray-300 outline-[#5596e6]  text-gray-900"
              ...
              <div>
                <input
                  ...
                  className="w-full px-4 py-5 border rounded-md border-gray-300 outline-[#5596e6] text-gray-900"
                  data-temp-mail-org="0"
                />
              </div>
              <div>
